...
console.log(result); // ['bread', 'carrot', 'potato', 'chicken', 'apple', 'fruits']
//
// ------2------
const country = "USA";
...
console.log(
    users.filter(v => v.role === 'Full Stack Resident').map(v => v.firstName)
)
...
console.log(
    epic.reduce((result, word) => result += ` ${word}`)
)
